...
//@ts-check;
const periodicTableTemplate = document.createElement('template');
periodicTableTemplate.innerHTML = /* html */`
...
deframe(window, 'co-depends-periodic-table-js', periodicTableTemplate);
